...
using Quick_Application3.Core.Services;
...
using Quick_Application3.Server.Authorization.Requirements;
using Quick_Application3.Server.Configuration;
using Quick_Application3.Server.Services;
using Quick_Application3.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - Quick_Application3";
