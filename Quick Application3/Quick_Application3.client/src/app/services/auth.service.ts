...
import { IdToken, SignupResponse } from '../models/signup-response.model';
@Injectable()
export class AuthService {
  ...
  private processSignupResponse(response: SignupResponse): User {
    ...
    // Additional logic to save user details
    this.saveUserDetails(user, [], accessToken, '', new Date(), false); // No refresh token needed at signup
