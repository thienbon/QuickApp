...
export class OidcHelperService {
  ...
  private readonly signupEndpoint = '/connect/signup';
  ...
  signup(username: string, password: string, email: string, phoneNumber: string) {
    ...
    const params = new HttpParams()
      ...
      .append('client_id', this.clientId)
      .append('grant_type', 'password') // Or any appropriate grant type for signup
      .append('scope', this.scope);

    return this.http.post<SignupResponse>(this.signupEndpoint, params, { headers: header });
  }
